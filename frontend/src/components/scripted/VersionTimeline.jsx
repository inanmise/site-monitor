...
export default function VersionTimeline({
  ...
  return (
    <ol className="sc-vt">
      {rows.map(v => {
        const style = EVENT_STYLE[v.event_type] || DEFAULT_STYLE
            ...
            <div className="sc-vt-row" role="button" tabIndex={0} aria-pressed={selected}
              ...
              <span className="sc-vt-body">
                <span className="sc-vt-head">
                  <span className="sc-ver-chip sc-ver-chip--cell">v{v.version}</span>
              ...
              <ChevronRight size={15} className="sc-vt-caret" aria-hidden="true" />
            </div>
          </li>
        )
      })}

...
const FEATURES = [
  { Icon: ShieldCheck, text: 'Zincir & İptal Doğrulaması (OCSP/CRL)' },
  { Icon: Bell,        text: 'Çok Seviyeli Uyarı: WARNING · HIGH · CRITICAL' },
  { Icon: Globe,       text: 'Tüm domain\'lerinizi tek panelden izleyin' },
  { Icon: RefreshCw,   text: 'Her gece otomatik kontrol, anlık override' },
  { Icon: BarChart3,   text: 'Geçmiş, aktivite logu ve yenileme önerileri' },
]
...
function CertMonitorLogo() {
  return (
    <svg viewBox="0 0 160 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="lp-logo-svg">
      ...
      {/* Certificate tick (top-right badge) */}
...
export default function Login({ onLogin }) {
  ...
  // Kaydedilmiş kullanıcı adı varsa şifre alanına odaklan
  useEffect(() => {
    if (saved) {
      ...
      <div className="lp-left">
        <div className="lp-left-inner">
          <div className="lp-brand">
            ...
            <p className="lp-brand-tagline">SSL/TLS Sertifika İzleme Sistemi</p>
          </div>

          <ul className="lp-features">
            {FEATURES.map(({ Icon, text }) => (
              <li key={text} className="lp-feature-item">
          ...
          <div className="lp-left-footer">
            v{__APP_VERSION__} &nbsp;·&nbsp; &copy; {new Date().getFullYear()} CertMonitor
          </div>
        </div>
      ...
      <div className="lp-right">
        <div className="lp-form-wrap">
          ...
          <div className="lp-intro">
            ...
            <h2 className="lp-intro-title">Hesabınıza Giriş Yapın</h2>
            <p className="lp-intro-desc">
              Kurumunuzun SSL/TLS sertifikalarını merkezi olarak izlemek,
              sona erme uyarılarını yönetmek ve eskalasyon süreçlerini
              takip etmek için oturum açın.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="lp-form">
            <div className="lp-field">
              <label className="lp-label" htmlFor="lp-user">Kullanıcı Adı</label>
              <input
                id="lp-user"
                className="lp-input"
                type="text"
            ...
            <div className="lp-field">
              <label className="lp-label" htmlFor="lp-pass">Şifre</label>
            ...
            <label className="lp-remember">
              ...
              />
              <span>Beni Hatırla <em>(7 gün boyunca tekrar giriş yapma)</em></span>
            </label>
            ...
            <button type="submit" className="lp-btn" disabled={loading}>
              {loading
                ? <><span className="lp-spinner" /> Giriş yapılıyor...</>

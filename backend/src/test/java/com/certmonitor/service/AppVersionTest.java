...
class AppVersionTest {
    ...
    @Test
    @DisplayName("cert.monitor.version property'si varsa kazanır ve kaynak 'env' olur")
    void propertyWins_sourceEnv() {
        MockEnvironment env = new MockEnvironment().withProperty("cert.monitor.version", " 19.93.1 ");

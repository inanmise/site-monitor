...
class WhoisDomainClientTest {
    ...
    void serverFor_configOverride_winsOverBuiltin() {
        when(appSettings.getCsv("cert.monitor.domain.whois-servers", ""))
    ...
    void serverFor_noOverride_fallsBackToBuiltin() {
        when(appSettings.getCsv("cert.monitor.domain.whois-servers", "")).thenReturn(List.of());
    ...
    @Test
    @DisplayName("enabled: cert.monitor.domain.whois-enabled bayrağını yansıtır")
    void enabled_reflectsFlag() {
        when(appSettings.getBoolean("cert.monitor.domain.whois-enabled", false)).thenReturn(true);
    ...
    void lookup_whoisDisabled_returnsNoneError() {
        ...
        when(appSettings.getBoolean("cert.monitor.domain.whois-enabled", false)).thenReturn(false);

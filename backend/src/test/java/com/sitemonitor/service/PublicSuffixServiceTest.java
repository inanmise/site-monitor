...
class PublicSuffixServiceTest {
    ...
    void subdomain() {
        assertThat(psl.registrableDomain("www.example.com")).isEqualTo("example.com");
    ...
    void trSecondLevel() {
        assertThat(psl.registrableDomain("www.example.com.tr")).isEqualTo("example.com.tr");
    ...
    void tldOf() {
        assertThat(psl.tldOf("www.example.com.tr")).isEqualTo("tr");

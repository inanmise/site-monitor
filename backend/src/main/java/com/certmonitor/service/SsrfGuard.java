 ...
 *   <li>loopback / any-local (127/8, ::1, 0.0.0.0, ::) → {@code cert.monitor.monitoring.allow-loopback-targets}
 *       (vars. <b>false</b>) açık değilse reddedilir.</li>
 *   <li>site-local / ULA (iç/private ağ) → {@code cert.monitor.monitoring.allow-internal-targets} (vars.

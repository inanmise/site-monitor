...
import com.certmonitor.service.FailedLoginAnomalyService;
 ...
 * (bootstrap admin bypass). Kalıcılık aynı {@code app_settings} tablosuna {@code cert.monitor.failed-login.*}.
 */
@Slf4j
@RestController
...
public class LoginAnomalyController {
    ...
    private static final String P = "cert.monitor.failed-login.";
    ...
    public ResponseEntity<Map<String, Object>> getSettings(HttpSession session) {
        ...
        d.put("system_admin_email",               settingsService.getString("cert.monitor.system-admin.email", ""));
    ...
    public ResponseEntity<Map<String, Object>> testEmail(
        ...
        try {
            ...
            n.setSubject("[CertMonitor] Login anomali TEST maili");

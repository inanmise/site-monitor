...
public class GeoIpService {
    ...
    @Value("${site.monitor.geoip.api-url:http://ip-api.com/json/%s?fields=status,country,city,org}")
    private String apiUrl;

    @Value("${site.monitor.geoip.timeout-millis:500}")
    private long timeoutMillis;

    @Value("${site.monitor.geoip.cache-ttl-ms:3600000}")

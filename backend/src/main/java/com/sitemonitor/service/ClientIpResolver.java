 ...
 * sıralı aday başlık listesi YAPILANDIRILABİLİR (site.monitor.client-ip.headers). Böylece
...
public class ClientIpResolver {
    ...
    @Value("${site.monitor.client-ip.headers:X-Forwarded-For}")
    ...
    @Value("${site.monitor.client-ip.index:0}")
    private int index;

...
import com.sitemonitor.repository.IncidentImageRepository;
import com.sitemonitor.repository.IncidentOptionRepository;
...
public class IncidentService {
    ...
    @Value("${site.monitor.incident.image-max-bytes:5242880}")

...
public class AuditLifecycleListener {
    ...
    public void onStartup() {
        try {
            auditService.recordSystemEvent("SYSTEM_STARTUP", "SYSTEM", "application", "site-monitor başlatıldı");
        } catch (Exception e) {
    ...
    public void onShutdown() {
        try {
            auditService.recordSystemEvent("SYSTEM_SHUTDOWN", "SYSTEM", "application", "site-monitor kapatıldı");
        } catch (Exception e) {
